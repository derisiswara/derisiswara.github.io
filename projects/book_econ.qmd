...
description: "The code version of Application of Econometric Models with RStudio, a book released in 2023 by IPB Press. The book was written by Muhammad Firdaus, Tony Irawan, Fahmi Salam Ahmad, Hermanto Siregar, Deri Siswara, and Rodi Jakariya. "
author: Deri Siswara
date: 2/16/2024 
image: img/econ.png
citation: true
...
<a href="https://dseconometrics.netlify.app/" class="btn" role="button">{{< fa box >}} Site</a>
<a href="https://github.com/derisiswara/ds-econometrics" class="btn" role="button">{{< fa brands github >}} Code</a>
...
![](https://github.com/derisiswara/ds-econometrics/blob/main/images/cover.jpeg?raw=true){.img-center width=15em fig-alt="book econ logo"}